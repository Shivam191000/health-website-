        ...
        <div class="row">
          <div class="banner-info">
            <div class="banner-logo text-center">
              <img src="https://looka.com/s/156423615" class="img-responsive" style="width: 140px;">
            </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          <h3>Contact Info</h3>
          <div class="space"></div>
          <p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>Bareilly UttarPradesh<br> India, 243001</p>
          <div class="space"></div>
          <p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i>shivamgangwar1910@gmail.com</p>
          <div class="space"></div>
          <p><i class="fa fa-phone fa-fw pull-left fa-2x"></i>+91-8449642942</p>
        </div>
              ...
              <div class="w3-row-padding">
                <div class="w3-third">
                  <div class="social-buttons">        
                            ...
                            <!-- LinkedIn Button -->
                            <a href="https://www.linkedin.com/feed/?trk=guest_homepage-basic_google-one-tap-submit" class="social-margin" target="blank">
                              <div class="social-icon linkedin">
                                <i class="fa fa-linkedin" aria-hidden="true"></i>
                              </div> 
                            </a>
                            <!-- instagram Button -->
                            <a href="https://www.instagram.com/___shivam1910/" target="blank"  class="social-margin">
                              <div class="social-icon instagram">
                                <i class="fa fa-instagram" aria-hidden="true"></i>
                              </div>
                            </a>
                          <!-- Github Button -->
                            <a href="https://github.com/Shivam191000"  target="blank"  class="social-margin">
